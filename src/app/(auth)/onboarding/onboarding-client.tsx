...
import { REGISTRATION_PENDING_NOTICE } from '@/lib/farm-approval'
      ...
      {step === 4 && (
        ...
        >
          ...
          <h2 className="font-heading text-2xl font-semibold text-foreground mb-2">
            Dein Hof ist angelegt!
          </h2>
          {/* Bewusst NICHT „ist online": Der Hof wartet auf die Freigabe des
              Betreibers, seine Hofseite ist bis dahin nicht erreichbar. Einen
              Shop-Link zum Teilen anzubieten, der ins Leere führt, wäre der
              schlechteste denkbare erste Eindruck für die Kundinnen. */}
          <p className="text-sm text-muted-foreground mb-6 text-balance">
            {REGISTRATION_PENDING_NOTICE}
          </p>

          {shopUrl && (
            <div className="bg-muted rounded-xl px-4 py-3 mb-6 text-left">
              <p className="text-xs text-muted-foreground mb-1">Deine künftige Hof-Adresse</p>
