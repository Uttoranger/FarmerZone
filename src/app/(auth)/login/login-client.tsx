...
/**
 * Das Anmeldeformular. Verhalten unverändert — es ist nur aus page.tsx
 * herausgelöst, damit davor eine serverseitige Sitzungsprüfung stehen kann
 * (siehe page.tsx). Der IS_DEV-Schnellzugang bleibt, wie er war.
 */
