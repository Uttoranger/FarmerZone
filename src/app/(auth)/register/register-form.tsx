...
export function RegisterForm({ formToken }: { formToken: string }) {
  ...
  // Honigtopf: bleibt bei Menschen leer. Kein `required`, keine Rolle in
  // `canSubmit` — wer ihn nicht sieht, darf davon nichts merken.
        ...
        >
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            {/* Honigtopf — unsichtbar für Menschen, verlockend für Skripte.
                ...
                durch den Browser. Ein Mensch kommt also gar nicht an ihn
                heran; ist er trotzdem gefüllt, war es kein Mensch. */}
            <div style={HONIGTOPF_STIL} aria-hidden="true">
              <label htmlFor="website">Webseite (bitte frei lassen)</label>
              <input
                id="website"
                name="website"
                type="text"
            ...
            {/* Signierter Zeitstempel aus dem Seitenaufbau — die Zeitschranke
                in registerFarmer prüft ihn (src/lib/form-token.ts). */}
