  ...
  return (
    <div className={className}>
      ...
      {gebuehrErstattungOffen(order) && (
        <p className="mt-1.5 rounded-lg border border-amber-300 dark:border-amber-800/60 bg-amber-50 dark:bg-amber-950/40 px-3 py-2 text-xs font-medium text-amber-900 dark:text-amber-100">
          {GEBUEHR_ERSTATTUNG_OFFEN_HINWEIS}
        </p>
      )}
    </div>
